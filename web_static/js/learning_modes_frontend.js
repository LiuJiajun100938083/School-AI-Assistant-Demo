...
class LearningModeManager {
        ...
        const mockTasks = {
            ...
            'MEANING_BUILDER': {
                ...
                student_response_format: {
                    type: 'text',
                    rules_zh: ['用自己的話表達', '不要照抄原文', '保持主要意思']
                }
            },
            'WHATS_MISSING': {
                game_id: gameId,
                ...
                target_skill: '理解',
                level: level,
                instructions_zh: '閱讀原文和摘要，找出摘要中遺漏了什麼重要信息。',
                materials: {
                    passage_zh: '小明每天早上六點起床，先跑步半小時，然後吃早餐。他堅持這個習慣已經三年了，身體變得越來越健康。',
                    incomplete_summary_zh: '小明每天早上六點起床，然後吃早餐。'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['指出遺漏的信息', '說明為什麼這個信息重要']
                }
            },
            'ONE_SENTENCE_CAPTURE': {
                ...
                target_skill: '理解',
                level: level,
                instructions_zh: '用一句話概括這段文字的核心要點。',
                materials: {
                    passage_zh: '隨著科技的發展，手機已經成為人們生活中不可或缺的工具。人們用它來通訊、上網、拍照、支付。但是，過度使用手機也會帶來一些問題，比如影響睡眠和視力。'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['只用一句話', '抓住核心要點']
                }
            },
            // 表达类
            'CLARITY_REPAIR': {
                ...
                target_skill: '表達',
                level: level,
                instructions_zh: '這個句子表達不夠清楚，請修改使它更清晰。',
                materials: {
                    unclear_sentence_zh: '那個東西在那邊做那件事的時候很厲害。'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['讓句子更具體', '不要添加新內容', '保持原意']
                }
            },
            'ONE_LINE_OPINION': {
                game_id: gameId,
                ...
                target_skill: '表達',
                level: level,
                instructions_zh: '用一句話清晰地表達你對這個問題的立場和理由。',
                materials: {
                    question_zh: '學生應該在課堂上使用手機嗎？'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['包含立場（支持/反對）', '包含理由', '不超過50字']
                }
            },
            'SAY_MORE_WITH_LESS': {
                game_id: gameId,
                ...
                target_skill: '表達',
                level: level,
                instructions_zh: '這段文字太囉嗦了，請刪除多餘的詞句，保持原意。',
                materials: {
                    redundant_passage_zh: '在我個人的觀點看來，我認為基本上運動對於我們的身體健康來說是非常重要的一件事情。'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['刪除冗餘詞句', '保持原意', '讓表達更簡潔']
                }
            },
            // 结构类
            'LOGIC_SEQUENCER': {
                ...
                target_skill: '結構',
                level: level,
                instructions_zh: '這些句子的順序被打亂了，請排列成連貫的段落。',
                materials: {
                    sentences: [
                        '他決定每天早起半小時練習。',
                        '小明一直想學會游泳。',
                ...
                student_response_format: {
                    type: 'text',
                    rules_zh: ['寫出正確順序（如B-D-A-C）', '說明排序理由']
                }
            },
            'PARAGRAPH_ROLE': {
                game_id: gameId,
                ...
                target_skill: '結構',
                level: level,
                instructions_zh: '這個段落在文章中起什麼作用？請說明並提供證據。',
                materials: {
                    passage_zh: '在許多文化中，茶是日常生活的一部分。人們通常會在早晨和家人一起喝茶，或者在下午與朋友分享一杯茶。茶不僅是一種飲料，更是一種社交方式。'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['判斷功能（說明/舉例/總結等）', '引用文本作為證據']
                }
            },
            'OUTLINE_FIRST': {
                game_id: gameId,
                ...
                target_skill: '結構',
                level: level,
                instructions_zh: '為這個題目設計一個作文大綱，不需要寫完整段落。',
                materials: {
                    topic_zh: '我最難忘的一天',
                    requirements_zh: '記敘文，300字左右'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['列出開頭、中間、結尾的要點', '每部分2-3個關鍵詞']
                }
            },
            // 思维类
            'PERSPECTIVE_SWITCH': {
                ...
                target_skill: '思維',
                level: level,
                instructions_zh: '從另一個角色的視角重新描述這個情境。',
                materials: {
                    scenario_zh: '小華在圖書館大聲說話，被管理員提醒了。',
                    perspectives: ['小華', '管理員']
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['選擇一個角色', '描述他/她的想法和感受']
                }
            },
            'CHOOSE_AND_DEFEND': {
                game_id: gameId,
                ...
                target_skill: '思維',
                level: level,
                instructions_zh: '選擇一個觀點並說明你的理由。',
                materials: {
                    question_zh: '學校應該取消考試嗎？',
                    options: ['應該取消', '不應該取消']
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['明確選擇', '給出至少兩個理由']
                }
            },
            'WHAT_IF': {
                game_id: gameId,
                ...
                target_skill: '思維',
                level: level,
                instructions_zh: '想像如果情況改變，結果會如何不同。',
                materials: {
                    scenario_zh: '小明因為睡過頭錯過了公車，結果上學遲到了。',
                    change_zh: '如果小明前一晚早點睡覺'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['描述可能的不同結果', '說明原因']
                }
            },
            // 元认知类
            'DIFFICULTY_SPOT': {
                ...
                target_skill: '元認知',
                level: level,
                instructions_zh: '回顧剛才的學習，說說哪個部分最難，為什麼。',
                materials: {
                    task_zh: '剛才你完成了一個閱讀理解任務'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['指出最難的部分', '解釋為什麼覺得難']
                }
            },
            'CONFIDENCE_TAG': {
                game_id: gameId,
                ...
                target_skill: '元認知',
                level: level,
                instructions_zh: '回答問題後，評估你對答案的信心程度。',
                materials: {
                    question_zh: '「風」這個字的部首是什麼？',
                    options: ['風', '几', '虫', '丿']
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['選擇答案', '評估信心（很確定/有點確定/不太確定）']
                }
            },
            'NEXT_TIME_PLAN': {
                game_id: gameId,
                ...
                target_skill: '元認知',
                level: level,
                instructions_zh: '根據反饋，說說下次你會怎樣改進。',
                materials: {
                    feedback_zh: '你的回答抓住了主要意思，但可以更簡潔一些。'
                },
                student_response_format: {
                    type: 'text',
                    rules_zh: ['提出一個具體的改進方法', '說明如何實施']
                }
            }
        };

        // 返回对应游戏的mock数据
        return mockTasks[gameId] || mockTasks['MEANING_BUILDER'];
    }
    ...
    renderChineseMaterials(materials) {
        ...
        // 不完整摘要（WHATS_MISSING）
        if (materials.incomplete_summary_zh) {
            html += `
                <div class="summary-box">
                    <div class="box-label">📋 摘要（可能不完整）</div>
                    <div class="box-content">${materials.incomplete_summary_zh}</div>
                </div>
            `;
        }

        // 模糊句子（CLARITY_REPAIR）
        if (materials.unclear_sentence_zh) {
            html += `
                <div class="sentence-box">
                    <div class="box-label">✏️ 需要修改的句子</div>
                    <div class="box-content">${materials.unclear_sentence_zh}</div>
                </div>
            `;
        }

        // 问题（ONE_LINE_OPINION, CONFIDENCE_TAG等）
        if (materials.question_zh) {
            html += `<div class="question-box">❓ ${materials.question_zh}</div>`;
        }

        // 冗余段落（SAY_MORE_WITH_LESS）
        if (materials.redundant_passage_zh) {
            html += `
                <div class="passage-box redundant">
                    <div class="box-label">📝 需要精简的段落</div>
                    <div class="box-content">${materials.redundant_passage_zh}</div>
                </div>
            `;
        }

        // 句子列表（LOGIC_SEQUENCER）
        ...
        // 作文题目和要求（OUTLINE_FIRST）
        if (materials.topic_zh) {
            html += `<div class="topic-box">📝 作文題目：${materials.topic_zh}</div>`;
        }
        if (materials.requirements_zh) {
            html += `<div class="requirements-box">📋 要求：${materials.requirements_zh}</div>`;
        }

        // 情境描述（PERSPECTIVE_SWITCH, WHAT_IF）
        if (materials.scenario_zh) {
            html += `
                <div class="scenario-box">
                    <div class="box-label">📖 情境</div>
                    <div class="box-content">${materials.scenario_zh}</div>
                </div>
            `;
        }

        // 角色列表（PERSPECTIVE_SWITCH）
        if (materials.perspectives && Array.isArray(materials.perspectives)) {
            html += '<div class="perspectives-box"><div class="box-label">👥 角色</div><div class="perspectives-list">';
            materials.perspectives.forEach((p, i) => {
                html += `<span class="perspective-tag">${p}</span>`;
            });
            html += '</div></div>';
        }

        // 假设改变（WHAT_IF）
        if (materials.change_zh) {
            html += `<div class="change-box">🔄 假設：${materials.change_zh}</div>`;
        }

        // 选项列表（CHOOSE_AND_DEFEND, CONFIDENCE_TAG）
        if (materials.options && Array.isArray(materials.options)) {
            ...
            materials.options.forEach((opt, index) => {
                ...
                if (optText) {
                    html += `<div class="option-item"><span class="option-label">${String.fromCharCode(65 + index)}.</span> ${optText}</div>`;
                }
            });
            html += '</div>';
        }

        // 学习任务（DIFFICULTY_SPOT）
        if (materials.task_zh) {
            html += `<div class="task-box">📚 任務：${materials.task_zh}</div>`;
        }

        // 反馈（NEXT_TIME_PLAN）
        if (materials.feedback_zh) {
            html += `
                <div class="feedback-box">
                    <div class="box-label">💬 之前的反饋</div>
                    <div class="box-content">${materials.feedback_zh}</div>
                </div>
            `;
        }
    ...
    showChineseScaffold(element, data) {
        const questions = data.questions_zh || [];

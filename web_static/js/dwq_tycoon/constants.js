...
(function () {
    ...
    const DYNAMIC_LINES = [
        { from: '廣州', to: '深圳', unlockTurn: 6, stroke: '#ef4444', label: '廣深高鐵' },
        { from: '香港', to: '珠海', unlockTurn: 7, stroke: '#22c55e', label: '港珠澳大橋' },
        { from: '香港', to: '澳門', unlockTurn: 7, stroke: '#22c55e', label: '港珠澳大橋' },
        { from: '深圳', to: '中山', unlockTurn: 10, stroke: '#eab308', label: '深中通道' },
    ];

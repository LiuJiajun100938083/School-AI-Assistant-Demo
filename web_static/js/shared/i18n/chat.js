...
i18n.addMessages({
    zh: {
        ...
        'chat.backHome': '返回首頁',
        'chat.history': '對話歷史',
        'chat.archiveLabel': '對話錄',
        'chat.archiveTooltip': '對話歷史',
        'chat.archiveTooltipMac': '對話歷史  ⌘ K',
        'chat.archiveTooltipWin': '對話歷史  Ctrl K',
        'chat.archiveOpen': '打開對話歷史抽屜',
        'chat.archiveClose': '關閉對話歷史抽屜',
        'chat.newChat': '+ 新對話',
    ...
    en: {
        ...
        'chat.archiveLabel': 'ARCHIVE',
        'chat.archiveTooltip': 'Chat History',
        'chat.archiveTooltipMac': 'Chat History  ⌘ K',
        'chat.archiveTooltipWin': 'Chat History  Ctrl K',
        'chat.archiveOpen': 'Open chat history',
        'chat.archiveClose': 'Close chat history',

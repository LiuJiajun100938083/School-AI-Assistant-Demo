...
CREATE TABLE IF NOT EXISTS token_blacklist (
    ...
    expires_at  DATETIME NOT NULL                  COMMENT 'Token 原始過期時間',
    INDEX idx_jti (jti),
...
-- ============================================================
INSERT IGNORE INTO users (username, password_hash, display_name, role, is_active) VALUES
...
-- Verify
-- ============================================================
SELECT CONCAT('Done! Total tables: ',

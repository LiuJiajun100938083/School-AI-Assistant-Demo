...
CREATE TABLE IF NOT EXISTS practice_sessions (
    ...
    status ENUM('generating', 'generated', 'generation_failed', 'in_progress', 'completed', 'expired') DEFAULT 'generated',
    error_code VARCHAR(50) DEFAULT NULL COMMENT '生成失敗的錯誤代碼',
    error_message TEXT DEFAULT NULL COMMENT '生成失敗的錯誤訊息',
    started_at DATETIME,
